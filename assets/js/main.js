...
const favColour = prompt ('type your favorite colour');

console.log(userName + userSurname + favColour + '23');

document.getElementById('infos').innerHTML =  (userName + userSurname + favColour + '23');
